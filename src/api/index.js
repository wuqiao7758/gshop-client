...
// 2、获取食品分类列表
export const reqCategoryList = () => ajax('/index_category')
...
// 8、手机号验证码登陆
export const reqLoginSms = phone => ajax('/login_sms', { phone, code }, 'POST')

// 9、根据会话获取用户信息
export const reqUserInfo = phone => ajax('/userinfo')

// 10、用户登出
export const reqLogout = phone => ajax('/logout')
